...
app.controller('MyCtrl', ['$scope', '$http', '$timeout', '$compile', 'Upload', function ($scope, $http, $timeout, $compile, Upload) {
  ...
  function generateFile () {
    var blob = new Blob(videoPlayer.recordedBlobs, {type: 'video/mp4'});
  ...
  $scope.uploadS3 = function() {
    ...
    file.upload = Upload.upload({
      url: 'https://videowisp2.s3-us-west-2.amazonaws.com/',
      method: 'POST',
      data: {
        key: file.name,
        AWSAccessKeyId: 'AKIAINNO3M3HLXDDRLEQ',
        acl: 'public-read',
        policy: '',
        signature: 'M5+QfbP8ELaMOt3zjSMS8djMEIA=',
        "Content-Type": '',
        file: file,
        filename: 'test.mp4',
        file: file
